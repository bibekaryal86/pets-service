...
public class CategoryConnector {
  ...
  public RefCategoryResponse getAllCategories() {
    ResponseEntity<RefCategoryResponse> responseEntity =
        restTemplate.getForEntity(getAllCategoriesUrl, RefCategoryResponse.class);
  ...
  @CacheEvict(value = "categories", allEntries = true, beforeInvocation = true)
  public RefCategoryResponse updateCategory(
      @NonNull final String id, @NonNull final RefCategoryRequest refCategoryRequest) {
    String url = UriComponentsBuilder.fromHttpUrl(updateCategoryUrl).buildAndExpand(id).toString();

    ResponseEntity<RefCategoryResponse> responseEntity =
        restTemplate.exchange(
            url, PUT, new HttpEntity<>(refCategoryRequest, null), RefCategoryResponse.class);
  ...
  public RefCategoryResponse deleteCategory(@NonNull final String id) {
    String url = UriComponentsBuilder.fromHttpUrl(deleteCategoryUrl).buildAndExpand(id).toString();

    ResponseEntity<RefCategoryResponse> responseEntity =
        restTemplate.exchange(url, DELETE, new HttpEntity<>(null, null), RefCategoryResponse.class);
