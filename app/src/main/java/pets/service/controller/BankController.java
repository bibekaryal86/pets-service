...
public class BankController {
    ...
    public ResponseEntity<RefBankResponse> getBankById(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefBankResponse> saveNewBank(@PathVariable("username") String username,
                                                       @RequestBody RefBankRequest bankRequest) {
        logger.info("Save New Bank: {} | {}", username, bankRequest);

        if (!hasText(username) ||
                bankRequest == null ||
                !hasText(bankRequest.getDescription())
        ) {
    ...
    public ResponseEntity<RefBankResponse> updateBank(@PathVariable("username") String username,
                                                      @RequestParam("id") String id,
                                                      @RequestBody RefBankRequest bankRequest) {
    ...
    public ResponseEntity<RefBankResponse> deleteBank(@PathVariable("username") String username,
                                                      @RequestParam("id") String id) {
