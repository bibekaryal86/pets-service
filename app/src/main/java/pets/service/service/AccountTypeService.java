...
public class AccountTypeService {
  ...
  public RefAccountTypeResponse getAccountTypeById(String id) {
    ...
    if (refAccountTypeResponse.getStatus() == null) {
      accountType =
          refAccountTypeResponse.getRefAccountTypes().stream()
      ...
      if (accountType == null) {
        ...
        return RefAccountTypeResponse.builder().refAccountTypes(singletonList(accountType)).build();
      }
    } else {
  ...
  public RefAccountTypeResponse updateAccountType(
    ...
    try {
      ...
      logger.error(
          "Exception in Update Account Type for Id: {} | {}", id, refAccountTypeRequest, ex);
