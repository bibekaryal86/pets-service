...
public class TransactionController {
    ...
    public ResponseEntity<TransactionResponse> getTransactionById(@PathVariable("username") String username,
    ...
    public ResponseEntity<TransactionResponse> saveNewTransaction(@PathVariable("username") String username,
    ...
    public ResponseEntity<TransactionResponse> updateTransaction(@PathVariable("username") String username,
                                                                 @RequestParam("id") String id,
                                                                 @RequestBody TransactionRequest transactionRequest) {
    ...
    public ResponseEntity<TransactionResponse> deleteTransaction(@PathVariable("username") String username,
                                                                 @RequestParam("id") String id) {
