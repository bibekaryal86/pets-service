...
public class MerchantService {
    ...
    public MerchantService(MerchantConnector merchantConnector,
    ...
    public RefMerchantResponse deleteMerchant(String username, String id) {
        ...
        if (transactionResponse.getStatus() == null) {
            ...
            if (usedTransaction == null) {
                ...
                refMerchantResponse = response("Delete Merchant Unavailable! Merchant is Used in Transactions!!!", null);
            }
        } else {
            logger.error("Delete Merchant Error, Empty Transactions List: {} | {}", username, id);
            refMerchantResponse = response("Delete Merchant Unavailable! Error Retrieving Transactions!!!", null);
        }
