...
public class EndpointsConfig {
    ...
    @Bean
    public String getAccountsByUserUrl(@Value("${accounts_get_by_user}") String getAccountsByUserUrl) {
    ...
    @Bean
    public String getAllAccountTypesUrl(@Value("${account_types_get_all}") String getAllAccountTypesUrl) {
        return getAllAccountTypesUrl;
    }

    @Bean
    public String saveNewAccountTypeUrl(@Value("${account_type_save_new}") String saveNewAccountTypeUrl) {
    ...
    @Bean
    public String getAllCategoryTypesUrl(@Value("${category_types_get_all}") String getAllCategoryTypesUrl) {
        return getAllCategoryTypesUrl;
    }

    @Bean
    public String saveNewCategoryTypeUrl(@Value("${category_type_save_new}") String saveNewCategoryTypeUrl) {
        return saveNewCategoryTypeUrl;
    }

    @Bean
    public String updateCategoryTypeUrl(@Value("${category_type_update}") String updateCategoryTypeUrl) {
        return updateCategoryTypeUrl;
    }

    @Bean
    public String deleteCategoryTypeUrl(@Value("${category_type_delete}") String deleteCategoryTypeUrl) {
    ...
    @Bean
    public String getMerchantsByUserUrl(@Value("${merchants_get_by_user}") String getMerchantsByUserUrl) {
    ...
    @Bean
    public String getTransactionsByUserUrl(@Value("${transactions_get_by_user}") String getTransactionsByUserUrl) {
        return getTransactionsByUserUrl;
    }

    @Bean
    public String saveNewTransactionUrl(@Value("${transaction_save_new}") String saveNewTransactionUrl) {
        return saveNewTransactionUrl;
    }

    @Bean
    public String updateTransactionPutUrl(@Value("${transaction_update_put}") String updateTransactionPutUrl) {
    ...
    @Bean
    public String deleteTransactionsByAccountUrl(@Value("${transactions_delete_by_account}") String deleteTransactionsByAccountUrl) {
        return deleteTransactionsByAccountUrl;
    }

    @Bean
    public String getAllTransactionTypesUrl(@Value("${transaction_types_get_all}") String getAllTransactionTypesUrl) {
        return getAllTransactionTypesUrl;
    }

    @Bean
    public String saveNewTransactionTypeUrl(@Value("${transaction_type_save_new}") String saveNewTransactionTypeUrl) {
        return saveNewTransactionTypeUrl;
    }

    @Bean
    public String updateTransactionTypeUrl(@Value("${transaction_type_update}") String updateTransactionTypeUrl) {
        return updateTransactionTypeUrl;
    }

    @Bean
    public String deleteTransactionTypeUrl(@Value("${transaction_type_delete}") String deleteTransactionTypeUrl) {
