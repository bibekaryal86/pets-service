...
public class CategoryTypeController {
    ...
    public ResponseEntity<RefCategoryTypeResponse> getCategoryTypeById(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefCategoryTypeResponse> getAllCategoryTypes(@PathVariable("username") String username,
                                                                       @RequestParam(name = "usedInTxnsOnly", required = false, defaultValue = "false") boolean usedInTxnsOnly) {
    ...
    public ResponseEntity<RefCategoryTypeResponse> saveNewCategoryType(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefCategoryTypeResponse> updateCategoryType(@PathVariable("username") String username,
                                                                      @RequestParam("id") String id,
                                                                      @RequestBody RefCategoryTypeRequest categoryTypeRequest) {
    ...
    public ResponseEntity<RefCategoryTypeResponse> deleteCategoryType(@PathVariable("username") String username,
                                                                      @RequestParam("id") String id) {
