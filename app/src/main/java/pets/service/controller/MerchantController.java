...
public class MerchantController {
    ...
    public ResponseEntity<RefMerchantResponse> getMerchantById(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefMerchantResponse> getMerchantsByUser(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefMerchantResponse> saveNewMerchant(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefMerchantResponse> updateMerchant(@PathVariable("username") String username,
                                                              @RequestParam("id") String id,
                                                              @RequestBody RefMerchantRequest merchantRequest) {
    ...
    public ResponseEntity<RefMerchantResponse> deleteMerchant(@PathVariable("username") String username,
                                                              @RequestParam("id") String id) {
