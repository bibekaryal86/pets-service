...
public class CategoryTypeConnector {
    ...
    public CategoryTypeConnector(@Qualifier("restTemplate") RestTemplate restTemplate,
    ...
    public RefCategoryTypeResponse getAllCategoryTypes() {
        ResponseEntity<RefCategoryTypeResponse> responseEntity = restTemplate
                .getForEntity(getAllCategoryTypesUrl, RefCategoryTypeResponse.class);

        return responseEntity.getBody();
    }

    @CacheEvict(value = "categoryTypes", allEntries = true, beforeInvocation = true)
    public RefCategoryTypeResponse saveNewCategoryType(@NonNull final RefCategoryTypeRequest refCategoryTypeRequest) {
        ResponseEntity<RefCategoryTypeResponse> responseEntity = restTemplate
                .exchange(saveNewCategoryTypeUrl,
                        POST,
    ...
    @CacheEvict(value = "categoryTypes", allEntries = true, beforeInvocation = true)
    public RefCategoryTypeResponse updateCategoryType(@NonNull final String id,
                                                      @NonNull final RefCategoryTypeRequest refCategoryTypeRequest) {
        String url = UriComponentsBuilder
                .fromHttpUrl(updateCategoryTypeUrl)
                .buildAndExpand(id)
                .toString();
    ...
    public RefCategoryTypeResponse deleteCategoryType(@NonNull final String id) {
        ...
        String url = UriComponentsBuilder
                .fromHttpUrl(deleteCategoryTypeUrl)
                .buildAndExpand(id)
                .toString();
