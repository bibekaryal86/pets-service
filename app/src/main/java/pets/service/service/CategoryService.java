...
public class CategoryService {
  ...
  public RefCategoryResponse getAllCategories(
      String username, RefCategoryFilters refCategoryFilters) {
    ...
    if (refCategoryFilters != null) {
      ...
      if (refCategoryFilters.isUsedInTxnsOnly()) {
        transactions =
            transactionService.getTransactionsByUser(username, null, false).getTransactions();
      }
  ...
  public RefCategoryResponse getCategoryById(String id) {
    ...
    if (categoryResponse.getStatus() == null) {
      ...
      if (category == null) {
        ...
        return RefCategoryResponse.builder().refCategories(singletonList(category)).build();
      }
    } else {
      return categoryResponse;
    }
  ...
  private void applyAllDetails(RefCategoryResponse categoryResponse) {
    RefCategoryTypeResponse categoryTypeResponse =
        categoryTypeService.getAllCategoryTypes(null, false);
