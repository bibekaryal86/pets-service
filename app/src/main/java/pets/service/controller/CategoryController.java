...
public class CategoryController {
    ...
    public ResponseEntity<RefCategoryResponse> getCategoryById(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefCategoryResponse> getAllCategories(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefCategoryResponse> saveNewCategory(@PathVariable("username") String username,
    ...
    public ResponseEntity<RefCategoryResponse> updateCategory(@PathVariable("username") String username,
                                                              @RequestParam("id") String id,
                                                              @RequestBody RefCategoryRequest categoryRequest) {
    ...
    public ResponseEntity<RefCategoryResponse> deleteCategory(@PathVariable("username") String username,
                                                              @RequestParam("id") String id) {
