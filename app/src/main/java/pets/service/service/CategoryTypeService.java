...
public class CategoryTypeService {
  ...
  public CategoryTypeService(
      CategoryTypeConnector categoryTypeConnector, @Lazy TransactionService transactionService) {
  ...
  public RefCategoryTypeResponse getAllCategoryTypes(String username, boolean usedInTxnsOnly) {
    ...
    if (usedInTxnsOnly) {
      TransactionResponse transactionResponse =
          transactionService.getTransactionsByUser(username, null, true);
      refCategoryTypeResponse =
          applyUsedInTransactionsOnlyFilter(
              refCategoryTypeResponse.getRefCategoryTypes(), transactionResponse.getTransactions());
    }
  ...
  public RefCategoryTypeResponse getCategoryTypeById(String id) {
    ...
    if (refCategoryTypesResponse.getStatus() == null) {
      categoryType =
          refCategoryTypesResponse.getRefCategoryTypes().stream()
