...
public class AccountTypeController {
  ...
  public ResponseEntity<RefAccountTypeResponse> getAccountTypeById(
  ...
  public ResponseEntity<RefAccountTypeResponse> getAllAccountTypes(
  ...
  public ResponseEntity<RefAccountTypeResponse> updateAccountType(
    ...
    if (!hasText(username) || !hasText(id) || accountTypeRequest == null) {
