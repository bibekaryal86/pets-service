...
public class BasicAuthInterceptor implements ClientHttpRequestInterceptor {
    ...
    public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
        ...
        request.getHeaders().setBasicAuth(authConfig.get(BASIC_AUTH_USR_PETSDATABASE), authConfig.get(BASIC_AUTH_PWD_PETSDATABASE));
    ...
    private Map<String, String> getAuthConfig() {
        ...
        if (System.getProperty(BASIC_AUTH_USR_PETSDATABASE) != null) {
            // for running locally
            authConfigMap.put(BASIC_AUTH_USR_PETSDATABASE, System.getProperty(BASIC_AUTH_USR_PETSDATABASE));
            authConfigMap.put(BASIC_AUTH_PWD_PETSDATABASE, System.getProperty(BASIC_AUTH_PWD_PETSDATABASE));
