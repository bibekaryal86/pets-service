...
public class ReportsController {
    ...
    public ResponseEntity<ReportsResponse> getCurrentBalancesReport(@PathVariable("username") String username) {
        logger.info("Get Current Balances Report: {}", username);

        if (!hasText(username)) {
            return response("Error Retrieving Current Balances Report! Invalid Request!! Please Try Again!!!");
        } else {
    ...
    public ResponseEntity<ReportsResponse> getCashFlowsReport(@PathVariable("username") String username,
    ...
    public ResponseEntity<ReportsResponse> getCategoriesReport(@PathVariable("username") String username,
                                                               @RequestParam("selectedyear") String selectedYear) {
    ...
    private ResponseEntity<ReportsResponse> response(String errMsg) {
        return new ResponseEntity<>(ReportsResponse.builder()
