...
public class Constants {
  ...
  protected static final List<String> ACCOUNT_TYPES_DEPOSIT_ACCOUNTS =
      asList(
          ACCOUNT_TYPE_ID_CASH,
          ACCOUNT_TYPE_ID_CHECKING,
          ACCOUNT_TYPE_ID_OTHER_DEPOSITS,
          ACCOUNT_TYPE_ID_SAVINGS,
          ACCOUNT_TYPE_ID_INVESTMENT);

  protected static final List<String> ACCOUNT_TYPES_LOAN_ACCOUNTS =
      asList(
  ...
  protected static final List<String> SYSTEM_DEPENDENT_MERCHANTS =
      asList(MERCHANT_ID_TRANSFER, MERCHANT_ID_FAMILY, MERCHANT_ID_CASH_RECON);
  ...
  public static final List<String> CATEGORY_ID_LOAN_PAYMENTS =
      asList(
          CATEGORY_ID_AUTO_PAYMENT, // NOSONAR
          CATEGORY_ID_MORTGAGE_PAYMENT,
          CATEGORY_ID_OTHER_LOAN_PAYMENT);
