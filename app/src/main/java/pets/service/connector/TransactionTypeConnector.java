...
public class TransactionTypeConnector {
  ...
  public TransactionTypeConnector(
  ...
  public RefTransactionTypeResponse getAllTransactionTypes() {
    ResponseEntity<RefTransactionTypeResponse> responseEntity =
        restTemplate.getForEntity(getAllTransactionTypesUrl, RefTransactionTypeResponse.class);

    return responseEntity.getBody();
  }

  @CacheEvict(value = "transactionTypes", allEntries = true)
  public RefTransactionTypeResponse saveNewTransactionType(
      @NonNull final RefTransactionTypeRequest refTransactionTypeRequest) {
    ResponseEntity<RefTransactionTypeResponse> responseEntity =
        restTemplate.exchange(
            saveNewTransactionTypeUrl,
            POST,
  ...
  @CacheEvict(value = "transactionTypes", allEntries = true)
  public RefTransactionTypeResponse updateTransactionType(
      @NonNull final String id,
      @NonNull final RefTransactionTypeRequest refTransactionTypeRequest) {
    String url =
        UriComponentsBuilder.fromHttpUrl(updateTransactionTypeUrl).buildAndExpand(id).toString();
  ...
  public RefTransactionTypeResponse deleteTransactionType(@NonNull final String id) {
    String url =
        UriComponentsBuilder.fromHttpUrl(deleteTransactionTypeUrl).buildAndExpand(id).toString();

    ResponseEntity<RefTransactionTypeResponse> responseEntity =
        restTemplate.exchange(
            url, DELETE, new HttpEntity<>(null, null), RefTransactionTypeResponse.class);
